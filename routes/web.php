...
Route::middleware('AuthAdmin')->prefix('admin')->group(function () {
  ...
  Route::get('/admin/dashbord', [AdminController::class, 'dashboard'])->name('admin.admin.dashboard');
...
// Member Routes
Route::get('/member/dashboard', [DashboardMember::class, 'index'])->name('member.dashboard');